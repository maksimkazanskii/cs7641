...
scaler = StandardScaler()
X = scaler.fit_transform(X)
transformer = TruncatedSVD(n_components=7, n_iter=10, random_state=111)
...
plt.title("Cumulative variance, truncated SVD")
plt.xlabel('Component number') , plt.ylabel('Cumulative variance')
plt.savefig("plots/diabetes_svd_cum_variance.png",bbox_inches='tight')
...
scaler = StandardScaler()
X = scaler.fit_transform(X)
transformer = TruncatedSVD(n_components=3, n_iter=10, random_state=111)
X = transformer.fit_transform(X)
ratios      = transformer.explained_variance_ratio_
...
np.save("data/diabetes_svd_kmeans_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_svd_kmeans_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_svd_clustering1',bbox_inches='tight')
...
plt.savefig('plots/diabetes_svd_clustering_2',bbox_inches='tight')
...
plt.savefig("plots/diabetes_svd_kmeans_sillhouttes.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_svd_kmeans_mutual.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_svd_inertia.png",bbox_inches='tight')
...
np.save("data/diabetes_svd_me_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_svd_me_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_svd_clustering2_me.png',bbox_inches='tight')
...
plt.xlabel('Number of Clusters') , plt.ylabel('Sillhouettes score')
plt.savefig("plots/diabetes_svd_me_sillhouttes.png",bbox_inches='tight')
...
plt.xlabel('Number of Clusters') , plt.ylabel('Mutual info score')
plt.savefig("plots/diabetes_svd_me_mutual.png",bbox_inches='tight')
