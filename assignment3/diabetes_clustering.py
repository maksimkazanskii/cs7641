...
np.save("data/diabetes_kmeans_main_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_kmeans_main_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_clustering1',bbox_inches='tight')
...
plt.savefig('plots/diabetes_clustering2',bbox_inches='tight')
...
plt.savefig("plots/diabetes_kmeans_sillhouttes.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_kmeans_mutual.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_inertia.png",bbox_inches='tight')
...
np.save("data/diabetes_me_main_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_me_main_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_clustering1_me',bbox_inches='tight')
...
plt.savefig('plots/diabetes_clustering2_me',bbox_inches='tight')
...
plt.xlabel('Number of Clusters') , plt.ylabel('Sillhouettes score')
plt.savefig("plots/diabetes_me_sillhouttes.png",bbox_inches='tight')
...
plt.title("Mutual info score (K-Means algorithm). ")
plt.xlabel('Number of Clusters') , plt.ylabel('Mutual info score')
plt.savefig("plots/diabetes_me_mutual.png",bbox_inches='tight')
