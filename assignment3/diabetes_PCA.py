...
plt.savefig("plots/diabetes_pca_eigenvalues.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_pca_cum_variance.png",bbox_inches='tight')
...
np.save("data/diabetes_kmeans_pca_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_kmeans_pca_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_pca_clustering1',bbox_inches='tight')
...
plt.savefig('plots/diabetes_pca_clustering_2d_kmeans',bbox_inches='tight')
...
plt.savefig("plots/diabetes_pca_kmeans_sillhouttes.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_pca_kmeans_mutual.png",bbox_inches='tight')
...
plt.savefig("plots/diabetes_pca_inertia.png",bbox_inches='tight')
...
np.save("data/diabetes_pca_me_sils.npy",SILHOUETTES)
SILHOUETTES = np.load('data/diabetes_pca_me_sils.npy', allow_pickle=True)
...
plt.savefig('plots/diabetes_clustering1_me_pca.png',bbox_inches='tight')
...
plt.savefig('plots/diabetes_pca_clustering2d_me.png',bbox_inches='tight')
...
plt.xlabel('Number of Clusters') , plt.ylabel('Sillhouettes score')
plt.savefig("plots/diabetes_pca_me_sillhouttes.png",bbox_inches='tight')
...
plt.xlabel('Number of Clusters') , plt.ylabel('Mutual info score')
plt.savefig("plots/diabetes_pca_me_mutual.png",bbox_inches='tight')
